...
(function ($, Drupal) {
  ...
  Drupal.checkoutPaneOverview = {
    ...
    onDrop: function () {
      ...
      // Because I made a change on select element. @ninghao.net
      var regionField = $rowElement.find('.ui.dropdown.pane-step select');

      // Keep the Step dropdown up to date.
      // regionField.val(regionName);
      // Use Semantic UI dropdown module behavior to set select element value. @ninghao.net
      regionField.dropdown('set selected', regionName);
