    ...
    attach: function (context, settings) {
      ...
      function updateBlockWeights(table, region) {
        ...
        table.find('.region-' + region + '-message').nextUntil('.region-title')
          .find('.ui.dropdown.block-weight select').val(function () {
      ...
      tableDrag.onDrop = function () {
        ...
        var regionField = $rowElement.find('.ui.dropdown.block-region-select select');
        ...
        if (!regionField.is('.block-region-' + regionName)) {
          var weightField = $rowElement.find('.ui.dropdown.block-weight');
